 ...
 * This class generates a smile graphic.
 */
...
public class Smile extends JPanel {
    ...
    public static final int Y_RIGHT_EYE = Y_FACE + 140;
    public static final int X_LEFT_EYE = X_FACE + 110;
    public static final int Y_LEFT_EYE = Y_FACE + 140;
    ...
    public void paint(Graphics g) {
        ...
        g.fillArc(X_MOUTH, Y_MOUTH, MOUTH_WIDTH, MOUTH_HEIGHT, MOUTH_START_ANGLE,
                MOUTH_ARC_SWEEP);
        g.setColor(Color.WHITE);
        g.fillArc(X_MOUTH, Y_MOUTH, MOUTH_WIDTH, MOUTH_HEIGHT - 35, MOUTH_START_ANGLE,
                MOUTH_ARC_SWEEP);
        ...
        g.setColor(Color.white);
        g.fillOval(X_RIGHT_EYE - 5, Y_RIGHT_EYE + 15, EYE_WIDTH + 10, EYE_HEIGHT - 5);
        g.fillOval(X_LEFT_EYE - 5, Y_LEFT_EYE + 15, EYE_WIDTH + 10, EYE_HEIGHT - 5);
    }
